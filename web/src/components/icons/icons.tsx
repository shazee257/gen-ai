...
//   className = defaultTailwindCSS,
// }: IconProps) => {
//   // Preserve original aspect ratio so layout doesn’t shift
//   const VIEWBOX_W = 2640;
//   const VIEWBOX_H = 733;
//   const aspectRatio = VIEWBOX_W / VIEWBOX_H;
//   const height = size / aspectRatio;

//   // Generate a clean outward spiral of dots (suggests “generation/tokens”)
//   const spiralDots = Array.from({ length: 26 }, (_, i) => {
//     const t = (i / 26) * 3.6 * Math.PI; // turns
//     const baseR = 90 + i * 12;          // radius growth
//     const cx = 520;                      // spiral center (inside bubble)
//     const cy = 295;
//     const x = cx + Math.cos(t) * baseR;
//     const y = cy + Math.sin(t) * baseR;
//     const r = 4 + i * 0.9;               // dot size growth
//     return { x, y, r };
//   });
...
//       className={`w-[${size}px] h-[${height}px] ` + (className || "")}
//     >
//       <title id="genai-logo-title">Gen.Ai — Generative AI Chat</title>

//       <defs>
//         {/* Vibrant default gradient for the mark; override with CSS vars if desired */}
//         <linearGradient id="gaiGradient" x1="0" y1="0" x2="1" y2="1">
//           <stop offset="0%" stopColor="var(--gai-start, #22d3ee)" /> {/* cyan-400 */}
//           <stop offset="100%" stopColor="var(--gai-end, #8b5cf6)" />   {/* violet-500 */}
//         </linearGradient>

//         {/* Soft glow behind the spiral for dark backgrounds */}
//         <radialGradient id="gaiGlow" cx="50%" cy="50%" r="50%">
//           <stop offset="0%" stopColor="#ffffff" stopOpacity=".20" />
//           <stop offset="100%" stopColor="#ffffff" stopOpacity="0" />
//         </radialGradient>

//         {/* Gentle shadow for the bubble outline */}
...
//       {/* ===================== MARK: Chat bubble + generative spiral ===================== */}
//       <g transform="translate(110, 90)" filter="url(#softShadow)">
//         {/* Chat bubble */}
//         <g stroke="url(#gaiGradient)" fill="none" strokeLinecap="round" strokeLinejoin="round">
//           <rect x="20" y="20" width="860" height="520" rx="120" strokeWidth="38" />
//           {/* Tail */}
//           <path d="M430 540 L345 650 L345 520" strokeWidth="38" />
//         </g>

//         {/* Subtle inner glow (helps on deep black) */}
//         <circle cx="520" cy="295" r="210" fill="url(#gaiGlow)" />

//         {/* Generative spiral of dots */}
//         <g fill="url(#gaiGradient)">
//           {spiralDots.map((d, i) => (
...
//       {/* ===================== WORDMARK: White on the right ===================== */}
//       <g paintOrder="stroke fill">
//         {/* Crisp white text for black background */}
//         <text
//           x="1120"
//           y="380"
//           fill="#ffffff"
//           stroke="#000000"
//           strokeOpacity="0"          // no stroke by default; keep for easy toggling if needed
//           strokeWidth="0"
//           fontFamily="Inter, ui-sans-serif, system-ui, -apple-system, Segoe UI, Roboto, Helvetica Neue, Arial, 'Noto Sans', 'Liberation Sans', sans-serif"
//           fontSize="320"
//           fontWeight={900}
...
//         {/* Underline accent (gradient) for a premium feel; subtle so it won’t fight the white text */}
//         <path
//           d="M1120 510 C1520 565, 1960 565, 2360 510"
//           fill="none"
//           stroke="url(#gaiGradient)"
//           strokeOpacity=".35"
//           strokeWidth="22"
